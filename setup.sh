...
audio=yes # install pipewire audio server
wireplumber=yes # use pipewire with wireplumber or pulseaudio-utils
thunar=yes # optional install thunar and extra packages
nm=yes # optional install NetworkManager
nano_config=yes # configure nano with line number
moz_enable=yes # enable firefox to run in wayland protocol
